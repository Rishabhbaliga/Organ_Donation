...
public class Doctor_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pWord =(EditText)findViewById(R.id.password3);
            ...
            public void onClick(View v) {
                try {
                    ...
                    if(!struName.equals("")&&!strpword.equals("")) {
                        ...
                        String query = "select * from doctor where name='" + struName + "'";
                        ...
                        if (struName.equals(uname1) && strpword.equals(pword1)) {
                            Intent i = new Intent(Doctor_Login.this, Doctors_handle.class);
                            startActivity(i);
                            finish();
                        } else {
        ...
        fPword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent signup = new Intent(Doctor_Login.this, Doctor_signup.class);
                signup.putExtra("src", "doctor");
